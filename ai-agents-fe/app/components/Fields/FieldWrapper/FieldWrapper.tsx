	...
	return (
		<div className={className}>
			<div className='mb-1 flex items-center '>
				<div className='label-L2 font-semibold text-white text-sm'>{label}</div>
				{required && (
					<div className='bg-status1-20 ml-2 rounded-full p-0 pb-0 pl-[7px] pr-[7px]'>
						<div className='text-status1-70 text-[10px] font-bold'>
							{'Required'}
						</div>
					</div>
				)}
			...
			{(error || success || helperText) && (
				<div className='mt-1 flex flex-row items-center'>
					<div
						className={classNames(`label-L2 ml-[7px] text-sm`, {
